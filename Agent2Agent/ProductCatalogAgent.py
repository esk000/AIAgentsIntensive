...
product_catalog_a2a_app = to_a2a(
    product_catalog_agent, port=8002  # Port where this agent will be served
)
attach_auth_middleware(product_catalog_a2a_app)
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(product_catalog_a2a_app, host="0.0.0.0", port=8002)