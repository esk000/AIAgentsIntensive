...
def show_python_code_and_result(response):
    for i in range(len(response)):
        ...
        if (response[i].content.parts) and (response[i].content.parts[0]) and (response[i].content.parts[0].function_response) and (response[i].content.parts[0].function_response.response):
...
async def main():
    ...
    print("\n=== Enhanced Currency Conversion Result ===\n")
    print(response)
